...
<div class="long_uc f_l">
	...
	<ul>
		<li class="current"><a href="/index.php?ctl=uc_account">帐户设置</a></li>
		<li ><a href="/index.php?ctl=uc_account&act=work">工作认证</a></li>
	</ul>
</div>
				...
				<tr>
					<td class="pt10" style="width:460px">
						...
						<div class="field real_name">
							...
							<input type="text" value="张三" readonly="readonly" disabled="true" class="f-input readonly" id="settings-real_name" name="real_name" size="30">
						</div>
						<div class="field idno">
							<label for="settings-idno"><span class="red">*</span>身份证号</label>
							<input type="text" value="32070619830507****" readonly="readonly" disabled="true" class="f-input readonly" id="settings-idno" name="idno" size="30" onkeyup="idcheck(this);" >
						</div>
						<div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>手机号码</label>
							<input type="text" value="13851941123"  class="f-input readonly" id="settings-mobile" name="mobile" size="30">
													</div>
						<div class="field">
