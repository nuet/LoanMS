...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="dialog">
        <div class="block">
            <p class="block-heading">Sign Up --Sorry, Not Allowed to sign up to admin portal.</p>
            <div class="block-body">
                <form action="signin.php" method="post">
                    ...
                    <input type="submit" class="btn btn-primary pull-right" value="Sign Up!" name="signup">
