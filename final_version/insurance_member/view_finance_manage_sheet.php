...
<div class="long_uc f_l">
	...
	<ul>
        ...
        <li class="current"><a href="view_finance_manage_sheet.php?orgID=<?php echo $orgID;?>">企业财务债务表管理</a></li>
...
<div id="borrowed" class="tc">
	<?php
	$sheet_query="select * from t_balance_sheet where organizationID=".$orgID;
	...
	while($sheet_row = mysql_fetch_array($sheet_result))
		{
			$submission_sql="select * from users where userID=".$sheet_row['submissionUser'];
			...
			echo'
                ...
                <div class="f_l" style="width:120px;height: 64px;" align="center">
                     <a href="view_balance_sheet.php?sheetID='.$sheet_row['sheetID'].'&orgID='.$orgID.'">详情</a>
                </div>
