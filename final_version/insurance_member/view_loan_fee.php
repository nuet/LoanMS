...
<div class="inc wb">
	<div id="dashboard" class="dashboard">
		<ul>
			<li ><a href="view_loan_payment.php?loanID=<?php echo $loanID;?>&orgID=<?php echo $orgID;?>">贷款还款信息</a></li>
           <li ><a href="view_loan_mortgage.php?loanID=<?php echo $loanID;?>&orgID=<?php echo $orgID;?>">贷款抵押/质押信息</a></li>
            <li class="current"><a href="view_loan_fee.php?loanID=<?php echo $loanID;?>&orgID=<?php echo $orgID;?>">贷款管理费信息</a></li>
		</ul>
	</div>
