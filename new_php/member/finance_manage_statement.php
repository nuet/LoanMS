...
<div class="long_uc f_l">
	...
	<ul>
		<li class="current"><a href="finance_manage_statement.php">企业财务损益表管理</a></li>
        <li ><a href="finance_manage_sheet.php">企业财务债务表管理</a></li>
        <li ><a href="credit_score.php">企业信用估值历史</a></li>
	</ul>
</div>
	...
	while($statement_row = mysql_fetch_array($statement_result))
		{
			...
			echo'
                ...
                <div class="f_l" style="width:120px;height: 64px;" align="center">
                     <a href="income_statement.php?statementID='.$statement_row['statementID'].'"; target="_blank">详情</a>
                </div>
