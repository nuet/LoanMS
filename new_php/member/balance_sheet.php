...
if($_SERVER["REQUEST_METHOD"] == "POST" and $_POST['submit']!="")
	{
		if($_POST['grossAssets']!="" and $_POST['floatingAssets']!="" and $_POST['longequityInvest']!="" and $_POST['grossDebt']!="" and $_POST['dividendsPayables']!="")
		{
