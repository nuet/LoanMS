...
if($_SERVER["REQUEST_METHOD"] == "POST" and $_POST['submit']!="")
	{
		if($_POST['mainIncome']!="" and $_POST['netProfit']!="" and $_POST['startyear']!="" and $_POST['startmonth']!="" and $_POST['startday']!="" and $_POST['endyear']!="" and $_POST['endmonth']!="" and $_POST['endday']!="")
		{
			...
			$incomeInsert="INSERT INTO t_income_statement SET organizationID='".$orgID."', statementDate='".$statementDate."',mainIncome='".$mainIncome."',mainCost='".$mainCost."',salesTax='".$salesTax."',mainProfit='".$mainProfit."', otherProfit='".$otherProfit."', businessCost='".$businessCost."', manageCost='".$manageCost."', financeCost='".$financeCost."', impairmentCost='".$impairmentCost."',investGain='".$investGain."',businessProfit='".$businessProfit."',otherIncome='".$otherIncome."',subsidyIncome='".$subsidyIncome."',otherCost='".$otherIncome."',profitTotal='".$profitTotal."',incomeTax='".$incomeTax."', netProfit='".$netProfit."', grossProfit='".$grossProfit."',netMargin='".$netMargin."',grossMargin='".$grossMargin."',submissionUser='".$userID."',startDate='".$startDate."',endDate='".$endDate."';";
			
			$incomeInsert_query = mysql_query($incomeInsert);
			if($incomeInsert_query)
			{
				$update_status=1;
				$update_result='企业财务损益表成功上传！请点击 <a href="finance_manage_statement.php"; style="color:red"> 这里 </a> 管理信息.';
        	}
        	else
        	{
				$update_status=0;
     		   	$update_result="对不起，企业财务损益表信息未成功上传。请重试。";
        	}    	
		}
		else
		{
...
<div class="long_uc f_l">
	...
	<ul>
		<li class="current"><a href="new_income_statement.php">企业财务损益表上传</a></li>
        <li ><a href="new_balance_sheet.php">企业财务负债表上传</a></li>
	</ul>
</div>
...
<div class="blank"></div>
<div class="item_group" style="width: 650px">上传新企业财务损益表  单位:万元</div>
			...
			<table width="738px" class="user_info_table">
				<tr>
					<td class="pt10" style="width:460px">						
						...
						<div class="field idno">
							<label for="settings-idno"><span class="red">*</span>主营业务收入</label>
							<input type="text" value="" class="f-input" id="mainIncome" name="mainIncome" size="30" onkeyup="idcheck(this);" >
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>主营业务成本</label>
							<input type="text" value="" id="mainCost" name="mainCost" size="30">
						</div>
						<div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>营业税及附加</label>
							<input type="text" value=""  id="salesTax" name="salesTax" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>主营利润</label>
							<input type="text" value=""  id="mainProfit" name="mainProfit" size="30">
						</div>
						<div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>主营外其它利润</label>
							<input type="text" value=""  id="otherProfit" name="otherProfit" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>营业费用</label>
							<input type="text" value=""  id="businessCost" name="businessCost" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>管理费用</label>
							<input type="text" value=""  id="manageCost" name="manageCost" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>财务费用</label>
							<input type="text" value=""  id="financeCost" name="financeCost" size="30">
						</div>
                         <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>资产减值损失</label>
							<input type="text" value=""  id="impairmentCost" name="impairmentCost" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>投资收益</label>
							<input type="text" value=""  id="investGain" name="investGain" size="30">
						</div>
						<div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>营业利润</label>
							<input type="text" value=""  id="businessProfit" name="businessProfit" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>营业外收入</label>
							<input type="text" value=""  id="otherIncome" name="otherIncome" size="30">
						</div>
						<div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>补贴收入</label>
							<input type="text" value=""  id="subsidyIncome" name="subsidyIncome" size="30">
						</div>                  
						<div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>营业外支出</label>
							<input type="text" value=""  id="otherCost" name="otherCost" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>利润总额</label>
							<input type="text" value=""  id="profitTotal" name="profitTotal" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>所得税</label>
							<input type="text" value=""  id="incomeTax" name="incomeTax" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>净利润</label>
							<input type="text" value=""  id="netProfit" name="netProfit" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>毛利润</label>
							<input type="text" value=""  id="grossProfit" name="grossProfit" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>净利率</label>
							<input type="text" value=""  id="netMargin" name="netMargin" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>毛利率</label>
							<input type="text" value=""  id="grossMargin" name="grossMargin" size="30">
						</div>
					</td>
