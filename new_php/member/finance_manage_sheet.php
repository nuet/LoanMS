...
<div class="long_uc f_l">
	...
	<ul>
		<li ><a href="finance_manage_statement.php">企业财务损益表管理</a></li>
        <li class="current"><a href="finance_manage_sheet.php">企业财务债务表管理</a></li>
	...
	while($sheet_row = mysql_fetch_array($sheet_result))
		{
			...
			echo'
                ...
                <div class="f_l" style="width:120px;height: 64px;" align="center">
                     <a href="balance_sheet.php?sheetID='.$sheet_row['sheetID'].'"; target="_blank">详情</a>
                </div>
