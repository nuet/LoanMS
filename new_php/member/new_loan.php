...
if($_SERVER["REQUEST_METHOD"] == "POST" and $_POST['submit']!="")
	{
		if($_POST['bankID']!="" and $_POST['loanType']!="" and $_POST['startyear']!="" and $_POST['startmonth']!="" and $_POST['startday']!="" and $_POST['endyear']!="" and $_POST['endmonth']!="" and $_POST['endday']!="" and $_POST['total']!="" and $_POST['mortgageType']!="" and $_POST['insuranceID']!="")
		{
			...
			if($newinsuranceID!=0)
				...
				$loanInsert="INSERT INTO t_loan SET bankID='".$newbankID."', loanType='".$newloanType."',organizationID='".$orgID."', startTime='".$newstartTime."', endTime='".$newendTime."', total='".$newtotal."', mortgageType='".$newmortgageType."';";
...
<div class="long_uc f_l">
	...
	<ul>
		<li class="current"><a href="org_profile.php">企业新贷款资料上传</a></li>
	</ul>
</div>
	...
	<div class="inc_main">
					...
					<td class="pt10" style="width:460px">						
						...
						<div class="field address">
							...
							<select name="insuranceID">
                             <option value="0" selected="selected">无保险</option>
                            《<?php
            ...
            <?php
				if($update_status==1)
					...
					echo '<center><label style="color:#C00"><h2>'.$update_result.' '.$loanInsert.'</h2></label></center>';			
			?>	
