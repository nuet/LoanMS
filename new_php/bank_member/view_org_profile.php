...
<div class="long_uc f_l">
	...
	<ul>
		<li class="current"><a href="view_org_profile.php?orgID=<?php echo $orgID;?>">公司基本资料管理</a></li>
		<li ><a href="view_org_legalrp.php?orgID=<?php echo $orgID;?>">公司法人资料管理</a></li>
	</ul>
</div>
				...
				<tr>
					<td class="pt10" style="width:460px">						
						...
						<div class="field mobile">
							...
							<input type="text" value="<?php echo $regLocation;?>"  readonly="readonly" disabled="true" class="f-input readonly" id="regLocation" name="regLocation" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>注册资本</label>
							<input type="text" value="<?php echo $regCapital;?>"  readonly="readonly" disabled="true" class="f-input readonly" id="regCapital" name="regCapital" size="30">
						</div>
                        <div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>注册执照编号</label>
							<input type="text" value="<?php echo $regLicence;?>"  readonly="readonly" disabled="true" class="f-input readonly" id="regLicence" name="regLicence" size="30">
						</div>
						<div class="field mobile">
							<label for="settings-mobile"><span class="red">*</span>注册所在部门</label>
							<input type="text" value="<?php echo $regAuthority;?>"  readonly="readonly" disabled="true" class="f-input readonly" id="regAuthority" name="regAuthority" size="30">
						</div>
						
						<div class="field address">
							<label for="settings-address"><span class="red">*</span>生产地址</label>
							<input value="<?php echo $prodLocation;?>" readonly="readonly" disabled="true" class="f-input readonly" name="prodLocation" id="prodLocation">
						</div>
						
						<div class="field address">
							<label for="settings-address"><span class="red">*</span>联系人姓名</label>
							<input value="<?php echo $contactName;?>" readonly="readonly" disabled="true" class="f-input readonly" name="contactName" id="contactName">
						</div>
                        
                        <div class="field address">
							<label for="settings-address"><span class="red">*</span>联系人邮箱</label>
							<input value="<?php echo $contactEmail;?>" readonly="readonly" disabled="true" class="f-input readonly" name="contactEmail" id="contactEmail">
						</div>
                        
                        <div class="field address">
							<label for="settings-address"><span class="red">*</span>联系人电话</label>
							<input value="<?php echo $contactPhone;?>" readonly="readonly" disabled="true" class="f-input readonly" name="contactPhone" id="contactPhone">
						</div>
                        <div class="field address">
							<label for="settings-address"><span class="red">*</span>公司情况备注</label>
							<textarea readonly="readonly" disabled="disabled" class="f-input readonly" row=50 col=100 name="appendum" id="appendum"><?php echo $appendum;?></textarea>
						</div>
