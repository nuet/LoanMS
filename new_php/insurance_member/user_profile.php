		...
		<div class="wrap">
			...
			<div class="nav">
				<ul>
					...
					<li class="downnav"><a href="">保险信息</a>
					<dl>
                        <dd><a href="loan_manage.php">已投保贷款</a></dd>
					</dl>
					</li>
...
<div class="long_uc f_l">
	...
	<ul>
        ...
        <li><a href="reset_password.php">更换密码</a></li>
...
<div class="blank"></div>
<div class="item_group" style="width: 660px">个人详细信息</div>
	...
	<div class="inc_main">
			<table width="738px" class="user_info_table">
				<tr>
					<td class="pt10" style="width:460px">
						...
						<div class="field mobile">
							...
							<input type="text" value="<?php echo $phone;?>"  class="f-input" id="settings-mobile" name="phone" size="30">
													</div>
						<div class="field">
                        ...
                        <div class="field address">
							...
							<input value="<?php echo $email;?>" class="f-input" name="email" id="email">
						</div>
						<div class="field address">
							<label for="haddress"><span class="red"></span>居住地址</label>
							<input value="<?php echo $haddress;?>" class="f-input" name="haddress" id="haddress">
						</div>
                        <div class="field address">
							<label for="haddress"><span class="red"></span>办公地址</label>
							<input value="<?php echo $baddress;?>" class="f-input" name="baddress" id="baddress">
						</div>
                        <div class="field address">
							<label for="haddress"><span class="red"></span>紧急联系人姓名</label>
							<input value="<?php echo $eName;?>" class="f-input" name="eName" id="eName">
						</div>
                        <div class="field address">
							<label for="ePhone"><span class="red"></span>紧急联系人手机</label>
							<input value="<?php echo $ePhone;?>" class="f-input" name="ePhone" id="ePhone">
						</div>
                        <div class="field address">
							<label for="ePhone"><span class="red"></span>紧急联系人邮箱</label>
							<input value="<?php echo $eEmail;?>" class="f-input" name="eEmail" id="eEmail">
						</div>
				...
				<tr>
					<td colspan="2">
						<div class="blank"></div>
						<div class="clearfix b" style="padding: 10px 90px">请确保您填写的资料真实有效，所有资料将会严格保密。一旦被发现所填资料有虚假，将会影响您在秉信成金融服务的信用，对以后借款造成影响。</div>
						<div class="blank"></div>
					</td>
				</tr>
			</table>
...
<div class="info f_l">
    ...
    <table id="info_dksp_status" style="border-collapse:collapse;">
		...
		<tr>
			<td>
            <?php 
			$loan_stats_result=mysql_query('select DISTINCT organizationID from t_loan where insuranceID='.$orgID);
			$loan_stats_num=mysql_num_rows($loan_stats_result);
			echo $loan_stats_num;
			?>
            </td>
			<td><?php
			$loan_stats2_result=mysql_query('select total from t_loan where insuranceID='.$orgID);
			$loan_stats2_sum=0;
			...
			?></td>
			<td><?php
			$loan_stats3_result=mysql_query('select DISTINCT bankID from t_loan where bankID is NOT NULL and insuranceID='.$orgID);
