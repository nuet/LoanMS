...
<div class="user_login_bar clearfix">
	...
	<!--登录表单-->
		...
		$(document).ready(function(){
				...
				{
					$.showErr("Email格式错误，请重新输入或者帐号格式错误，请重新输入",function(){
...
//				alert(ajaxobj.responseText);
						...
						<h3>合作网站账号登录</h3><span id='api_Sina_0'><script type='text/javascript'>load_api_url('Sina',0);</script></span><span id='api_Tencent_0'><script type='text/javascript'>load_api_url('Tencent',0);</script></span>						</div>
					</div>
				</div>
